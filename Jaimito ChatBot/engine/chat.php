...
if (isset($_GET['msg'])) {
    ...
    $bot->hears($msg, function (Bot $botty) {
        ...
        if ($msg == 'qual é o seu nome?') {
            $botty->reply('Buenos dias! Que bom que perguntou, eu sou o <strong>' . $botty->getNome() . '</strong>  e estou aqui para ajudá-lo');
            die();
        ...
        } else if (preg_match('/cep/', $msg) == 1) {
            $cep = str_replace(["-", ' ', '.', '-', ',', ';'], "", $msg);

            preg_match('/\d*$/', $cep, $matches); 
            ...
            if ($msg == "ajuda") {
                ...
                $botty->reply('Olá, bom dia! Digite "ajuda" para verificar as opções disponíveis!');
                die();
